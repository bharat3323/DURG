import 'package:durg/chats/Model/Post_Model.dart';
import 'package:durg/chats/Comment_Screen.dart';
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(likeCounts[index] > 0 ? '(${likeCounts[index]})' : '',
                  ...
                  IconButton(
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> const Comment_Screen()));
                    },
